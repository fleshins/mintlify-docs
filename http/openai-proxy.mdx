...
**Managed API keys:** If Brixo stores your LLM Provider API keys, omit the `LLM_PROVIDER_KEY` env var (above) and the `Authorization` header (below).
...
3. [**Create Trace *with* Observations**](https://www.notion.so/Brixo-Proxy-Traces-API-Developer-Guide-27029b346a988000882af102ad1e80b3?pvs=21)
