...
description: "Brixo Conversation Analytics — Quickstart"
---

# Brixo Conversation Analytics — Quickstart

Brixo transforms raw AI conversations into business-ready insights — user goals, topics, friction, sentiment, and resolution outcomes — without requiring heavy agent instrumentation or observability pipelines.
